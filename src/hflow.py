...
class HierarchyFlow(nn.Module):
    ...
    def __init__(
        ...
        self.feat_channel_mult = feat_channel_mult
        self.pad_size = pad_size

        flow_channels = (inp_channels, *[inp_channels * mult for mult in flow_channel_mult])
        feat_channels = (inp_channels, *[inp_channels * mult for mult in feat_channel_mult])
